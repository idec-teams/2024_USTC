...
const text = {
  ...
  text3: [
    ...
    {
      src: _Figure6,
      text: "Figure 6. A. Molecular docking simulation TtgR with naringenin chalcone ",
    },
    {
      text: "For a more sensitive biosensor, we refer to the binding mode of phloretin to TtgR to guide the construction of naringenin chalcone-targeted sensors. The site 176 is a high affinity one for phloretin. In Pseudomonas putida strain KT2440, which has a low tolerance to toxic chemicals, the corresponding amino acid is glycine. Studies have shown that G176R can effectively enhance the binding ability to phloretin.  For pathway product detection, with reference to the yield concentration achievable in existing production (1+g/L), we want a sensor that could be applied in large-scale production, with lower sensitivity and higher requirements for inducer concentration. Based on the current research, we select to mutate site N110, site L66 and site V96. Each site individually showed a clear decrease in affinity for naringenin and phloretin, which demonstrated a better rate of DNA release only at higher concentration. At the same time, those mutations had a higher affinity for naringenin than for phloretin. ",
    },
    {
      src: _Figure7,
      text: "Figure 7. A. Molecular docking modeling of TtgR mutant(G176R) with phloretin; B. Molecular docking modeling of TtgR mutant(L66A, V96A, N110A, G176R) with phloretin; C. Molecular docking modeling of TtgR mutant(G176R) with naringenin; D. Molecular docking modeling of TtgR mutant(L66A, V96A, N110A, G176R) with naringenin; E. Molecular docking modeling of wild-type TtgR with phloretin; F. Molecular docking modeling of wild-type TtgR with naringenin;",
    },
  ],
  text4: [
    {
      subtitle: "Directed Evolution of CHS",
      text: "The designed and constructed intracellular biosensor can reflect the amount of product by fluorescence intensity. Although CHS can catalyze p-coumaroyl coenzyme A in one step to obtain detectable naringenin chalcone. However, the price of p-coumaroyl coenzyme A is relatively high, so we decided to use its precursor, p-coumaric acid, as a substrate. Then we inserted the mutant sequence of CHS and CHI gene into the constructed pACYCDuet-1-4CL to obtain a series of plasmids for targeted evolutionary effect detection. Ultimately, the TtgRGFP biosensor will be applied to detect the concentration of naringenin in vivo, which can reflex the result of direct evolution of CHS. As shown in Figure 8, we will transform both plasmids into V. natriegens. With the combination of 4CL, CHS and CHI, the bacterium can produce naringenin from p-coumalic acid. The catalyst ability varies among different CHS mutants, resulting in various naringenin concentration in different clones. Compared to HPLC, biosensor can reflex real-time naringenin concentration and can save time from preparing the samples for HPLC, making it a useful tool in directed evolution. ",
    },
    {
      src: _Figure8,
      text: "Figure 8. Dual plasmid system for in high-throughput screening of V. natriegens",
    },
    {
