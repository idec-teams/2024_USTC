...
class Sidebaritem extends (0,ef_core__WEBPACK_IMPORTED_MODULE_0__.create)([{t:'a',p:[[['href'],[0,[['href'],'home.html']]]]},[{t:'li',a:{class:[['sidebar-item ',''],[['itemName']]]}},[{t:'i',a:{class:'iconfont icon'}}],[{t:'span',a:{class:'text'}}],[['itemName']]]]) {
};
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"Team":{"link":{"href":""},"item":[{"itemName":"member","href":"member.html"},{"itemName":"member","href":"member.html"}]},"Future":{"link":{"href":"future.html"},"item":[]}}');
...
new _sidebar_eft__WEBPACK_IMPORTED_MODULE_4__["default"]().$mount({ target: document.body });
for (let [key, value] of Object.entries(_sidebarlist_json__WEBPACK_IMPORTED_MODULE_7__)) {
  const sidebarsubtoggle = new _sidebarsubtoggle_eft__WEBPACK_IMPORTED_MODULE_5__["default"]({
    $data: {
      itemName: key,
  ...
  value.item.forEach(function (element) {
    array.push(
      new _sidebaritem_eft__WEBPACK_IMPORTED_MODULE_6__["default"]({
        $data: {
